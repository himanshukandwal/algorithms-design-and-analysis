 ...
 *      The last 10 digits make up the local number, while the digits before those make up the country code. Note that the country code is optional. We want to expose only the last
 *      4 digits and mask all other digits.
 *
 *      The local number should be formatted and masked as "***-***-1111", where 1 represents the exposed digits.
 *      To mask a phone number with country code like "+111 111 111 1111", we write it in the form "+***-***-***-1111".  The '+' sign and the first '-' sign before the local number
 ...
 * @author Hxkandwal
 */
public class MaskingPersonalInformation extends AbstractCustomTestRunner {
