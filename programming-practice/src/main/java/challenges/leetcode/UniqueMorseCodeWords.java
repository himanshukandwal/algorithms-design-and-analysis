 ...
 * @author Hxkandwal
 */
public class UniqueMorseCodeWords extends AbstractCustomTestRunner {

    public int _uniqueMorseRepresentations(String[] words) {
        String[] codes = { ".-","-...","-.-.","-..",".","..-.","--.","....","..",".---","-.-",".-..","--","-.","---",".--.","--.-",".-.","...","-","..-","...-",".--","-..-","-.--","--.." };
        Set<String> set = new HashSet<>();
        for (String w : words) {
            StringBuilder sb = new StringBuilder();
            for (char c : w.toCharArray()) sb.append (codes [c - 'a']);
            set.add (sb.toString());
        }
        return set.size();
    }
