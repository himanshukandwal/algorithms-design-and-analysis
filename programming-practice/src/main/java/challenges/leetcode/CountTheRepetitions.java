 ...
 * @author Hxkandwal
 */
public class CountTheRepetitions extends AbstractCustomTestRunner {
	
	private static CountTheRepetitions _instance = new CountTheRepetitions();
	
	private CountTheRepetitions() {}
