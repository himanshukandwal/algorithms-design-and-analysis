 ...
 * questions like: "Hi, A. Do you know B?" to get information of whether A knows B. You need to find out the celebrity (or verify there 
 ...
 * @author Hxkandwal
 */
public class FindTheCelebrity extends AbstractCustomTestRunner {
	...
	private boolean knows(int celeb, int idx) {
		return false;
	}
